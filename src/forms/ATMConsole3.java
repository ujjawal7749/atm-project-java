 ...
 * @author ujjaw
 */
public class ATMConsole3 extends javax.swing.JFrame {
    /**
     * Creates new form ATMConsole
     */
    
    String cnic;
    public ATMConsole3(String cnic) {
        initComponents();
        codes.LinkedList list = codes.ReadWrite.Read();
        String bal = list.returnbalance(cnic);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ATMConsole3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new ATMConsole3().setVisible(true);
            }
        });
    }
